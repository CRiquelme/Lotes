    ...
    <div class="steps-content px-4 py-4">
        ...
        <section id="paso2">
          ...
          <div class="mt-5 grid">
            <label class="uk-form-label uk-text-large" for=""
              >Marca en la imagen, como es el frente del terreno, en relación al
              acceso:
      ...
      <div v-show="steps[current].title === 'Paso 3'">
        <section id="paso3">
          ...
          <div class="py-4">
            <p class="text-lg">
              Opcional pero muy "Importante"... puedes adjuntar aquí documentos
              del terreno, que sean públicos... "Eso si, te advierto"... Si
              alguien se pone en contacto contigo y hace mención de estos
              documentos casi seguro que estas bastante cerca de vender.
            </p>
...
<script>
  ...
  export default {
    ...
    created () {
        ...
        .then( ()=>{
          //cantones inicial
          let link="https://ubicaciones.paginasweb.cr/provincia/" + document.getElementById('selectPrv').value + "/cantones.json"
